...
<footer class="text-center">
    <div class="footer-below">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    Copyright &copy; HostelWorld 2017.
                </div>
            </div>
        </div>
    </div>
...
<script src="<%=request.getContextPath()%>/static/js/validator.js"></script>
<script src="<%=request.getContextPath()%>/static/js/hostel.js"></script>
