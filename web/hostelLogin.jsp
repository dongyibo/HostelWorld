            ...
            <div class="col-sm-6 col-sm-offset-3 form-box">
                <div class="form-top" style="background: #f8f7e2">
                    <div class="form-top-left">
                        <h2>Hostel World</h2>
                        <h4 style="color: #0f0f0f">please input your id & password ~</h4>
                    </div>
                ...
                <div class="form-bottom" style="background-image: url(static/images/home/panel3.png)">
                    <form role="form" action="hostel-login" method="post" class="login-form">
                        ...
                        <div class="form-group">
                            <div class="col-lg-12" style="margin-top: 10px">
                                <a style="color: gray" href="hostelReg.jsp">Do not have an account? <span
